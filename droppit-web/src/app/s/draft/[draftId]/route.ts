...
export async function GET(
    ...
    const share = getDraftShareSpec(baseUrl, draftId);
    ...
    const description = escapeHtml("Review this saved draft in Droppit and continue the deploy flow on Base.");
...
<body style="margin:0;font-family:system-ui,sans-serif;background:#05070f;color:#fff;display:flex;min-height:100vh;align-items:center;justify-content:center;">
    <main style="max-width:560px;padding:24px;text-align:center;">
        ...
        <p style="margin:0 0 18px;color:#94a3b8;">Open this saved draft in Droppit to review details before deploying.</p>
        <a href="${escapeHtml(share.reviewUrl)}" style="display:inline-block;padding:12px 18px;border-radius:999px;background:linear-gradient(90deg,#0052FF,#22D3EE);color:#fff;text-decoration:none;font-weight:700;">Review draft</a>
    </main>
</body>
</html>`;
